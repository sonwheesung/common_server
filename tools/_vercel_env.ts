...
const KEYS = ['DATABASE_URL', 'ADMIN_TOKEN', 'CRON_SECRET', 'UPSTASH_REDIS_REST_URL', 'UPSTASH_REDIS_REST_TOKEN', 'DISCORD_TICKET_WEBHOOK_URL', 'DISCORD_TICKET_WEBHOOK_URL_MYWORD', 'SENTRY_DSN'];
