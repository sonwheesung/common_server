...
- **커밋 규약: `C:\project\common\COMMIT_CONVENTION.md`** — 형제 앱과 공유하는 정본이다.
  🔴 **값을 여기 베껴 적지 않는다.** 2026-09-09 대조에서 여덟 프로젝트 중 **다섯이 베껴 적고 있었고**,
  그건 그 문서 서문이 "이게 문제였다"고 지목한 바로 그 형태였다 — 원본이 바뀌어도 안 따라온다.
