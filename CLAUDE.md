...
| `jogak` | 일기 앱 (Expo, Android `com.son0925.jogak`, 구글 로그인) | **2026-09-02** | 🟢 **프로덕션**(19/0.2.6 · 게시 2026-09-04 · 1개국 · 2026-09-07 콘솔 실측). 웜 신호 **✅ 2026-09-04 도착** — 9/3의 `warmSince: null` 은 미부착이 아니라 **아무도 안 켠 날**이었다(아래 ①/② 규칙이 ②로 판정된 첫 실례). 2026-08-09 등록. 문의는 **로그인 필수** 구조. ⚠ 주체가 2행이다(아래 정의 참조) — 콘솔이 `subjectsDualCounted`로 **스스로 판정해 경고를 띄운다**(앱 코드 하드코딩 아님) |
